...
# player.fill((WHITE))
player_imgs = [pygame.transform.scale(
    pygame.image.load(IMGS_PATH + '/' + file).convert_alpha(), (150, 75)) for file in listdir(IMGS_PATH)]
...
def create_bonus():
    ...
    # bonus.fill(GREEN)
    bonus = pygame.transform.scale(pygame.image.load('bonus.png').convert_alpha(), (80, 120))
...
while is_working:
    ...
    main_surface.blit(font.render(str(scores), True, ORANGE), (width - 30, 0))
